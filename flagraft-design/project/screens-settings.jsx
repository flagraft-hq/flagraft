    ...
    <div>
      <PageHeader
        ...
        sub={
          <>
            ...
            behaves — defaults, access, retention. Settings apply across all environments unless
            noted.
          </>
        }
        actions={
          <Button variant="ghost" leftIcon="book">
            Docs
          </Button>
        }
      />
      ...
      <div className="settings-grid">
        <aside className="settings-rail">
          ...
          >
            Settings are versioned. Every change appears in the{' '}
  ...
  return (
    <>
        ...
        footer={
          <>
            <span className="muted" style={{ fontSize: 12 }}>
              Last edited <span className="mono">2026-05-09 17:02</span> by{' '}
              <span className="mono">k_a91c</span>
            </span>
      ...
      >
        ...
        <Row
          label="Slug"
          hint={<>Used in URLs and the SDK config. Changing this rotates all admin keys.</>}
        >
        ...
        <Row
          label="Project icon"
          hint="Two-letter mark and a color swatch for the project switcher."
        >
          <div className="row" style={{ gap: 12 }}>
            <span className="proj-avatar" data-color={color} aria-hidden="true">
        ...
        >
          <textarea
            className="input"
            rows={3}
            defaultValue="Customer-facing checkout web experience. Owns cart, address, payment, confirmation."
  ...
  return (
    <>
      ...
      >
        ...
        >
          <div className="seg">
            <button className="seg-btn" aria-pressed="true">
              Off everywhere
            </button>
        ...
        <Row
          label="Required tags"
          hint="Authors must apply at least one of these when creating a flag."
        >
          <div className="row" style={{ flexWrap: 'wrap', gap: 6 }}>
            ...
            <button className="badge add-tag">
        ...
        <Row
          label="Key pattern"
          hint={<>Validated client-side and on the server. Reject anything that doesn't match.</>}
        >
          <input className="input mono" defaultValue="^[a-z][a-z0-9.\-]{2,63}$" />
        </Row>
        <Row
          label="Force namespace"
          hint="Require keys to start with one of these prefixes (good for big projects)."
        >
        ...
        <Row
          ...
          hint="Flag is flagged as stale after this long without a value change."
        >
        ...
        <Row
          ...
          hint="Authors must write a one-line description before saving."
        >
          <Toggle checked={true} onChange={() => {}} />
        </Row>
      </SettingsCard>
...
function SettingsContext() {
  ...
  return (
    <>
      <SettingsCard
        ...
        sub={
          <>
            The attributes flag rules can target on. The SDK sends these alongside each evaluation;
            Flagraft compares them to your override rules.
          </>
        }
      >
  ...
  appVersion: '4.18.2',
          ...
          <div className="ctx-intro-note">
            ...
            <div>
              Only fields registered here can be referenced in{' '}
              <a href="#" onClick={(e) => e.preventDefault()} style={{ color: 'var(--pri-fg)' }}>
                override rules
              </a>
              . Unknown keys passed from the SDK are silently ignored — preventing typos like{' '}
              <span className="mono">userid</span> vs <span className="mono">userId</span> from
              quietly breaking rollouts.
            </div>
          </div>
        </div>
      </SettingsCard>
      ...
      <SettingsCard
        title={
          <>
            Registered fields{' '}
            <span className="muted num" style={{ fontWeight: 400, fontSize: 12.5 }}>
              · {fields.length}
            </span>
          </>
        }
        ...
        footer={
          <>
            <span className="muted" style={{ fontSize: 12 }}>
              Reserved: <span className="mono">_env</span>, <span className="mono">_flag</span>,{' '}
              <span className="mono">_now</span> are always available.
            </span>
            <span className="spacer" />
            ...
            {fields.map((f) => (
              <tr key={f.key}>
                <td>
                  ...
                  <div className="muted" style={{ fontSize: 12, marginTop: 3, maxWidth: 380 }}>
                    {f.desc}
                  </div>
                </td>
                <td>
                  <Tip tip={TYPES[f.type].desc}>
                    <Badge tone={TYPES[f.type].tone} mono>
                      {f.type}
                    </Badge>
                  </Tip>
                  {f.enumValues ? (
                    <div
                      className="row"
                      style={{ flexWrap: 'wrap', gap: 4, marginTop: 6, maxWidth: 220 }}
                    >
                ...
                <td>
                  <a
                    ...
                    className="ctx-usage"
                    title="See flags referencing this field"
                  >
                ...
                <td>
                  <div className="row" style={{ gap: 2 }}>
                    ...
                    <Tip
                      tip={
                        f.usedIn > 0 ? `In use by ${f.usedIn} flags — can't delete` : 'Delete field'
                      }
                    >
                      <button className="icon-btn" disabled={f.usedIn > 0}>
        ...
        <div className="ctx-flow">
          <div className="ctx-flow-step">
            ...
            <div>
              ...
              <div className="muted" style={{ fontSize: 12 }}>
                Fields not registered here are dropped.
              </div>
            </div>
          </div>
          ...
          <div className="ctx-flow-step">
            ...
            <div>
              ...
              <div className="muted" style={{ fontSize: 12 }}>
                Server + computed fields fill in.
              </div>
            </div>
          </div>
          <Icon name="arrowRight" size={16} className="ctx-flow-arrow" />
          <div className="ctx-flow-step">
            ...
            <div>
              ...
              <div className="muted" style={{ fontSize: 12 }}>
                First match wins — rule keys must exist in the registry.
              </div>
            </div>
          </div>
        </div>
...
function ContextFieldDialog({ open, editing, onClose }) {
  ...
  React.useEffect(() => {
    if (editing) setType(editing.type)
  }, [editing])
  ...
  return (
    <Modal open={open} onClose={onClose} size="lg">
      <div className="modal-header">
        ...
        <div className="sub">
          Defines a key that override rules can match on. Changes take effect on next evaluation.
        </div>
      </div>
      <div className="modal-body">
        ...
        <div className="field-row">
          <div className="field">
            <label>Source</label>
            <div className="seg">
              <button className="seg-btn" aria-pressed={editing?.source === 'sdk' || !editing}>
                SDK
              </button>
              <button className="seg-btn" aria-pressed={editing?.source === 'server'}>
                Server lookup
              </button>
              <button className="seg-btn" aria-pressed={editing?.source === 'computed'}>
                Computed
              </button>
            </div>
          ...
          <div className="field">
            ...
            <div className="row" style={{ height: 36 }}>
              <Toggle checked={!!editing?.required} onChange={() => {}} />
              <span className="muted" style={{ fontSize: 12 }}>
                Reject evaluations missing this field
              </span>
            </div>
          </div>
        </div>
        {type === 'enum' ? (
          <div className="field">
            ...
            <input
              ...
              placeholder="control, beta, alpha"
            />
            <span className="hint">
              Comma-separated. Rules can only compare against these values.
            </span>
          </div>
        ) : null}
        <div className="field">
          ...
          <span className="hint">
            Shown in the rule builder so editors know what shape to expect.
          </span>
        </div>
      </div>
    ...
    <>
      ...
      >
        <Row
          ...
          hint="How often a client refreshes its in-process cache. Lower = fresher, more load."
        >
          <div className="row" style={{ gap: 8, alignItems: 'center' }}>
            <input type="range" min="5" max="300" defaultValue="30" style={{ width: 220 }} />
            <span className="mono num" style={{ width: 56, textAlign: 'right' }}>
              30s
            </span>
          </div>
        </Row>
        ...
        <Row
          ...
          hint="If the SDK can't reach Flagraft within this, fall back to the offline default."
        >
          <div className="row" style={{ gap: 8, alignItems: 'center' }}>
            <input
              className="input num"
        ...
        <Row
          ...
          hint="What to return when the SDK has never seen this flag before."
        >
          <div className="seg">
            <button className="seg-btn" aria-pressed="true">
              off
        ...
        <Row
          label="Anonymous evaluations"
          hint={
            <>
              Allow <span className="mono">isEnabled(key)</span> without a user context.
            </>
          }
        >
    ...
    <>
      ...
      >
        <Row
          ...
          hint="Two distinct admin keys must approve before a prod toggle takes effect."
        >
          <Toggle checked={true} onChange={() => {}} />
        </Row>
        <Row
          label="Confirm typed slug"
          hint="When disabling a kill switch in prod, force the user to type the flag key."
        >
          <Toggle checked={true} onChange={() => {}} />
        </Row>
        <Row
          label="Window of caution"
          hint="Block prod writes during this window unless overridden."
        >
      ...
      <SettingsCard title="Network">
        <Row
          label="IP allowlist"
          hint="Restrict admin-key writes to these CIDR ranges. Reads from client keys are unaffected."
        >
        ...
        <Row
          label="SSO required"
          hint={<>Admin keys can only be issued to identities federated through SSO.</>}
        >
          <div className="row" style={{ gap: 8 }}>
            <Toggle checked={false} onChange={() => {}} />
            ...
            <a
              href="#"
              onClick={(e) => e.preventDefault()}
              style={{ color: 'var(--pri-fg)', fontSize: 12.5 }}
            >
              Set up SAML →
            </a>
          </div>
    ...
    <>
      <SettingsCard
        ...
        footer={
          <>
            <span className="muted" style={{ fontSize: 12 }}>
              {members.length} members · <span className="mono">6/25 seats</span>
            </span>
            <span className="spacer" />
              ...
              <tr key={m.email}>
                <td>
                  <div className="row" style={{ gap: 10 }}>
                    <span className="avatar" data-system={m.system ? 'true' : undefined}>
                      {m.initials}
                    </span>
                    <div>
                      <div style={{ fontWeight: 600, fontSize: 13.5 }}>
                        ...
                        {m.system ? (
                          <span style={{ marginLeft: 6 }}>
                            <Badge tone="slate">service</Badge>
                          </span>
                        ) : null}
                      </div>
                ...
                <td>
                  <Tip
                    tip={m.role === 'owner' ? 'Transfer ownership first' : 'Remove from project'}
                  >
                    <button className="icon-btn" disabled={m.role === 'owner'}>
                      <Icon name="trash" size={13} />
                    </button>
                  </Tip>
                </td>
          ...
          {[
            ...
            <div className="role-matrix-row" key={i}>
              ...
              {r.slice(1).map((v, j) => (
                <div key={j}>
                  {v ? (
                    <Icon name="check" size={14} style={{ color: 'var(--pri-fg)' }} />
                  ) : (
...
function SettingsWebhooks() {
  const hooks = [
    {
      name: 'Slack · #flagraft-alerts',
      url: 'https://hooks.slack.com/services/T0…/B07…',
      events: ['flag.enabled', 'flag.disabled', 'override.created'],
      status: 'ok',
      lastFire: '12 min ago',
    },
    {
      name: 'PagerDuty · prod killswitches',
      url: 'https://events.pagerduty.com/integration/c4f…/enqueue',
      events: ['flag.disabled', 'flag.enabled'],
      status: 'ok',
      lastFire: '4 hr ago',
    },
    {
      name: 'Datadog · audit stream',
      url: 'https://http-intake.logs.datadoghq.eu/v1/input/********',
      events: ['*'],
      status: 'fail',
      lastFire: '3 d ago',
      err: '401 unauthorized · last 12 attempts',
    },
  ]
  return (
    <>
      <SettingsCard
        ...
        footer={
          <>
            <span className="muted" style={{ fontSize: 12 }}>
              Signed with HMAC-SHA256 · header <span className="mono">X-Flagraft-Signature</span>
            </span>
            <span className="spacer" />
            <Button variant="ghost" leftIcon="play">
              Send test event
            </Button>
            <Button variant="primary" leftIcon="plus">
              Add webhook
    ...
    <>
      ...
      >
        ...
        <Row
          ...
          hint="Per-flag rule changes. Surface on the flag detail timeline."
        >
          <select className="select">
            <option>180 days</option>
            <option>90 days</option>
        ...
        <Row
          ...
          hint="A deleted flag can be restored from the trash for this long."
        >
          <div className="row" style={{ gap: 8, alignItems: 'center' }}>
      ...
      <SettingsCard title="Export & backup">
        <Row
          label="Daily backup"
          hint="Encrypted snapshot of flags, overrides, and settings to your S3 bucket."
        >
          <Toggle checked={true} onChange={() => {}} />
        </Row>
        <Row label="S3 destination">
          <input
            className="input mono"
            defaultValue="s3://kocharsoft-flagraft-backups/checkout-web/"
          />
        </Row>
  ...
  return (
    <>
      <div className="danger-banner">
        ...
        <div>
          <b>These actions are irreversible.</b> They affect every environment, every key, and every
          running SDK in this project.
        </div>
      </div>

      <SettingsCard
        title="Transfer ownership"
        sub="Move this project to another member of your organization. The current owner keeps admin access."
      >
        ...
        <Row label="Transfer to">
          <select className="select">
            ...
            <option>Aida Roussel · admin</option>
            <option>Marin Pé · admin</option>
          </select>
        </Row>
        <Row label="">
          <Button variant="ghost" onClick={() => setTransfer(true)}>
            Transfer project →
          </Button>
        </Row>
      </SettingsCard>
      ...
      <SettingsCard
        ...
        sub="Freezes flag state. The SDK still evaluates, but nothing can be edited until it's unarchived."
      >
        <div className="row" style={{ alignItems: 'flex-start' }}>
          <div style={{ flex: 1, fontSize: 13, color: 'var(--text-3)' }}>
            Archived projects don't count toward your seat or flag quotas. You can unarchive at any
            time.
          </div>
      ...
      <SettingsCard
        ...
        sub="Permanent. All flags, overrides, keys, and history are removed."
      >
        <div className="row" style={{ alignItems: 'flex-start' }}>
          <div style={{ flex: 1, fontSize: 13, color: 'var(--text-3)' }}>
            <span className="num">
            ...
            will be deleted. Backups in your S3 bucket are not touched.
          </div>
  ...
  return (
    <Modal open={open} onClose={onClose}>
      <div className="modal-header">
        ...
        <div className="sub">
          SDKs keep evaluating the last known state. No edits are possible until you unarchive.
        </div>
      </div>
      <div className="modal-body">
        <div
          style={{ padding: 12, background: 'var(--bg-subtle)', borderRadius: 8, fontSize: 12.5 }}
        >
          ...
          <ul
            style={{ margin: '6px 0 0 24px', padding: 0, color: 'var(--text-2)', lineHeight: 1.7 }}
          >
            <li>Read traffic continues to serve cached values.</li>
            <li>
              Write attempts return <span className="mono">423 Locked</span>.
            </li>
        ...
        <Button
          ...
          onClick={() => {
            ...
            toast.push({
              ...
              msg: 'Unarchive any time from the org dashboard.',
            })
          }}
        >
          Archive
  ...
  return (
    <Modal open={open} onClose={onClose}>
      <div className="modal-header">
        ...
        <div className="sub">
          Aida will become the new owner. You'll keep admin access and can be re-promoted.
        </div>
      </div>
      <div className="modal-body">
        <div className="field">
      ...
      <div className="modal-footer">
        ...
        <Button
          ...
          onClick={() => {
            onClose()
            toast.push({ title: 'Invitation sent', msg: 'Aida has 7 days to accept.' })
          }}
        >
  ...
  return (
    <Modal open={open} onClose={onClose}>
      <div className="modal-header">
        ...
        <div className="sub">
          This action is irreversible. SDK clients will receive <span className="mono">404</span>{' '}
          from the next evaluation onward.
        </div>
      </div>
      <div className="modal-body">
        <div
        ...
        >
          <b>24 flags · 62 overrides · 4 environments · 9 API keys</b> will be permanently deleted.
          Soft-delete recovery does <b>not</b> apply at the project level.
        </div>
        <div className="field" style={{ marginTop: 14 }}>
          <label>
            Type <span className="mono">checkout-web</span> to confirm
          </label>
          <input
            className="input mono"
            autoFocus
      ...
      <div className="modal-footer">
        ...
        <Button
          ...
          onClick={() => {
            ...
            toast.push({
              kind: 'error',
              title: 'Project queued for deletion',
              msg: 'Final purge in 24 hours.',
            })
          }}
        >
          Delete forever
