    ...
    <div>
      ...
      <Section title="Color tokens" icon="palette">
        <div className="card" style={{ padding: 18 }}>
          ...
          />
          <ColorRamp
            label="Amber · accent (overrides, warnings)"
            prefix="amber"
            tokens={['50', '100', '200', '300', '400', '500', '600', '700']}
          />
          <ColorRamp
            label="Red · production / destructive"
            prefix="red"
            tokens={['50', '100', '300', '500', '600', '700']}
          />
          <ColorRamp
            label="Ink · neutral ramp"
            prefix="ink"
            tokens={[
              '0',
              '50',
        ...
        <div className="grid-2" style={{ marginTop: 16 }}>
          ...
          <div className="card theme-dark" style={{ padding: 18, background: 'var(--bg-elev)' }}>
            <h4 style={{ margin: 0, fontSize: 13, fontWeight: 600, color: 'var(--text-1)' }}>
              Semantic — Dark
            </h4>
      ...
      <Section title="Typography" icon="code">
        <div className="card" style={{ padding: 24 }}>
          ...
          <TypeRow
            ...
            weight={600}
            name="Section / h2"
            sample="Override rules in production"
            font="sans"
            tracking="-0.01em"
          />
          <TypeRow
          ...
          <TypeRow
            ...
            weight={500}
            name="Body"
            sample="Disabling 3 flags in production. Existing overrides will still apply."
            font="sans"
          />
          <TypeRow
            size={12}
            weight={400}
            name="Caption"
            sample="Last evaluated 14ms ago · p99 22ms"
            font="sans"
          />
          ...
          <TypeRow
            size={13}
            weight={500}
            name="Mono — keys & values"
            sample="checkout.new-cart  ff_ad_a91c…  cohort=beta"
            font="mono"
          />
          <TypeRow
            size={12}
            weight={500}
            name="Mono caption"
            sample="GET /api/v1/client/features?userId=usr_123"
            font="mono"
          />
        </div>
      </Section>
            ...
            <div className="col" style={{ marginTop: 12, gap: 6 }}>
              {[
                ...
                <div className="row" key={n} style={{ fontSize: 12 }}>
                  ...
                  <div
                    style={{ width: v, height: 12, background: 'var(--teal-400)', borderRadius: 3 }}
                  />
        ...
        <div className="grid-2">
          <ComponentCard title="Toggle — the workhorse">
            <div className="col" style={{ gap: 14 }}>
              ...
              <div className="row">
                ...
                <span className="muted">medium · default</span>
              </div>
              <div className="row">
                <Toggle size="lg" checked={true} onChange={() => {}} />
                <span className="muted">large · detail view</span>
              </div>
              <div className="row">
                <Toggle production checked={true} onChange={() => {}} />
                <span style={{ color: 'var(--danger-fg)' }}>production · red ring when on</span>
              </div>
              <div className="row">
          ...
          <ComponentCard title="Buttons">
            <div className="col" style={{ gap: 10 }}>
              <div className="row">
                ...
                <Button variant="danger" className="solid">
                  Solid danger
                </Button>
              </div>
              <div className="row">
          ...
          <ComponentCard title="Inputs">
            <div className="col">
              ...
              <div className="field" style={{ margin: 0 }}>
                ...
                <span className="err">
                  <Icon name="alert" size={11} /> Must be lowercase.
                </span>
              </div>
            </div>
          </ComponentCard>
          ...
          <ComponentCard title="Override rule chip">
            ...
            <div className="muted" style={{ fontSize: 12, marginTop: 8 }}>
              The DSL is just chips. No one has to learn a query language.
            </div>
          </ComponentCard>

          <ComponentCard title="Env scope chip group">
            <div className="env-chips">
              <button className="env-chip" data-env="development" aria-pressed="true">
                <span className="dot" />
                development
              </button>
              <button className="env-chip" data-env="staging">
                <span className="dot" />
                staging
              </button>
              <button className="env-chip" data-env="production">
                <span className="dot" />
                production
              </button>
            </div>
            <div className="muted" style={{ fontSize: 12, marginTop: 10 }}>
              Lives in the topbar. Setting it filters every page to that environment.
            </div>
          </ComponentCard>
        </div>
      </Section>
      ...
      <Section title="Iconography" icon="sparkles">
        <div className="card" style={{ padding: 20 }}>
          ...
          <div className="muted" style={{ fontSize: 12, marginTop: 14 }}>
            All icons are 24×24 viewbox, 1.5px stroke, rounded joins. Hand-drawn for this prototype
            ...
            <tbody>
              {[
                [
                  'Flags list',
                  'covered',
                  'filter, bulk-select, per-env toggle, prod confirm',
                  'The page the team lives in. Designed for ops speed.',
                ],
                [
                  'Flag detail · Environments',
                  'covered',
                  'large toggles, override counts, latency hint',
                  '',
                ],
                [
                  'Flag detail · Overrides',
                  'covered',
                  'env scope, rule list, builder modal',
                  'Rules are evaluated top-to-bottom.',
                ],
                [
                  'Flag detail · Usage',
                  'covered',
                  'eval counts, latency, true-rate, snippet',
                  'Numbers are mock — wired to /api/v1/admin once available.',
                ],
                ...
                [
                  'Onboarding',
                  'covered',
                  '4-step flow with progress strip',
                  'Shown on first login per project.',
                ],
                [
                  'Degraded states',
                  'covered',
                  'inline cards + form validation',
                  'These appear contextually, not as a page.',
                ],
...
function ColorRamp({ label, prefix, tokens }) {
  return (
    <div style={{ marginBottom: 14 }}>
      ...
      <div
        style={{ display: 'grid', gridTemplateColumns: `repeat(${tokens.length}, 1fr)`, gap: 4 }}
      >
        {tokens.map((t) => (
          <div key={t}>
            <div
...
function SemanticRow({ label, var_, theme }) {
  ...
  return theme === 'dark' ? (
    <div className="theme-dark" style={{ color: 'var(--text-1)' }}>
      {wrap}
    </div>
  ) : (
    wrap
    ...
    >
      <div>
        ...
        <div className="mono muted" style={{ fontSize: 11 }}>
          {size}px / {weight} / {font === 'mono' ? 'JetBrains Mono' : 'Inter'}
        </div>
      </div>
      <div
        style={{
