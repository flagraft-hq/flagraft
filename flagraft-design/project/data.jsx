...
const FLAGS = [
  ...
  },
  {
    ...
    state: {
      development: { on: true, overrides: 0 },
      staging: { on: true, overrides: 0 },
      production: { on: true, overrides: 3 },
    },
    author: 'k_a91c',
  },
  {
  ...
  },
  {
    ...
    state: {
      development: { on: true, overrides: 4 },
      staging: { on: true, overrides: 2 },
      production: { on: false, overrides: 0 },
    },
    author: 'k_2f10',
  },
  ...
  },
  {
    ...
    state: {
      development: { on: true, overrides: 0 },
      staging: { on: true, overrides: 0 },
      production: { on: true, overrides: 0 },
    },
    author: 'k_2f10',
  },
  {
    ...
    state: {
      development: { on: true, overrides: 1 },
      staging: { on: false, overrides: 0 },
      production: { on: false, overrides: 0 },
    },
    author: 'k_a91c',
...
const OVERRIDES = [
  {
    id: 'ov_01',
    flag: 'checkout.new-cart',
    env: 'production',
    key: 'cohort',
    op: 'equals',
    val: 'beta',
    result: true,
    note: 'Beta cohort, week 2',
    created: '2026-05-10',
  },
  {
    id: 'ov_02',
    ...
    key: 'userId',
    op: 'in',
    val: 'usr_4291, usr_8810, usr_1132',
    result: true,
    note: 'Friendlies',
    created: '2026-05-09',
  },
  {
    ...
    val: 'eu',
    result: false,
    note: 'EU rollout paused',
    created: '2026-05-04',
  },
  {
    id: 'ov_04',
    flag: 'checkout.apple-pay',
    env: 'production',
    key: 'plan',
    op: 'equals',
    val: 'enterprise',
...
const API_KEYS = [
  {
    ...
    prefix: 'ff_rt_91a2',
    created: '2025-09-01',
    lastUsed: '2026-05-12 08:32',
    createdBy: 'cli',
  },
  {
    id: 'k_a91c',
    label: 'Checkout admin',
    scope: 'admin',
    project: 'Checkout Web',
    prefix: 'ff_ad_a91c',
    created: '2026-01-15',
    lastUsed: '2026-05-12 06:14',
    createdBy: 'k_root',
  },
  {
    id: 'k_2f10',
    ...
    prefix: 'ff_ad_2f10',
    created: '2026-03-02',
    lastUsed: '2026-05-11 22:50',
    createdBy: 'k_root',
  },
  {
    id: 'k_c441',
    label: 'Web client (prod)',
    scope: 'client',
    project: 'Checkout Web',
    env: 'production',
    prefix: 'ff_cl_c441',
    created: '2026-02-20',
    lastUsed: '2026-05-12 09:01',
    createdBy: 'k_a91c',
  },
  {
    id: 'k_c5e2',
    label: 'Web client (staging)',
    scope: 'client',
    project: 'Checkout Web',
    env: 'staging',
    prefix: 'ff_cl_c5e2',
    created: '2026-02-20',
    lastUsed: '2026-05-12 08:55',
    createdBy: 'k_a91c',
  },
]
...
const AUDIT = [
  {
    ...
    actor: 'k_root',
    type: 'enable',
    desc: 'Enabled `infra.read-replicas` in production',
    env: 'production',
  },
  {
    when: '08:32',
    ...
    actor: 'k_a91c',
    type: 'override',
    desc: 'Added override `cohort=beta` for `checkout.new-cart` in production',
    env: 'production',
  },
  {
    when: '06:14',
    ...
    actor: 'k_a91c',
    type: 'disable',
    desc: 'Disabled `checkout.new-cart` in production',
    env: 'production',
  },
  {
    when: '22:50',
    day: 'Yesterday, May 11',
    actor: 'k_2f10',
    type: 'enable',
    desc: 'Enabled `pricing.regional-tax-v2` in staging',
    env: 'staging',
  },
  {
    when: '17:02',
    ...
    actor: 'k_a91c',
    type: 'create',
    desc: 'Created flag `checkout.apple-pay`',
    env: '',
  },
  {
    when: '12:30',
    ...
    actor: 'k_a91c',
    type: 'keyIssued',
    desc: 'Issued client key `ff_cl_c441` for production',
    env: 'production',
  },
  {
    when: '09:11',
    ...
    actor: 'k_2f10',
    type: 'override',
    desc: 'Removed override `userId=usr_99` from `pricing.regional-tax-v2`',
    env: 'staging',
  },
  {
    when: '08:00',
    ...
    actor: 'k_root',
    type: 'envCreated',
    desc: 'Created environment `preview`',
    env: '',
  },
]
...
const CONTEXT_FIELDS = [
  {
    ...
    required: true,
    example: 'usr_4291',
    desc: 'Stable identifier for the end user. Used for sticky bucketing.',
    usedIn: 18,
  },
  {
    key: 'email',
    ...
    source: 'sdk',
    required: false,
    example: 'aida@kocharsoft.com',
    desc: 'Used by allow-list rules and internal-user targeting.',
    usedIn: 4,
  },
  {
    key: 'cohort',
    ...
    required: false,
    example: 'beta',
    desc: 'Experiment cohort assigned at signup.',
    enumValues: ['control', 'beta', 'alpha', 'internal'],
    usedIn: 7,
  },
  {
    key: 'plan',
    ...
    required: false,
    example: 'enterprise',
    desc: 'Billing plan. Looked up server-side from the customer record.',
  ...
  },
  {
    ...
    required: false,
    example: 'DE',
    desc: 'ISO 3166-1 alpha-2. Derived from request IP.',
    usedIn: 6,
  },
  {
    key: 'region',
    ...
    required: false,
    example: 'eu',
    desc: 'Coarse region used for rollout pausing.',
    enumValues: ['us', 'eu', 'apac', 'latam'],
    usedIn: 5,
  },
  {
    key: 'appVersion',
    ...
    required: false,
    example: '4.18.2',
    desc: 'Semver of the calling client. Supports range comparisons.',
    usedIn: 3,
  },
  {
    key: 'platform',
    ...
    required: false,
    example: 'web',
    desc: 'Where the SDK is running.',
    enumValues: ['web', 'ios', 'android', 'server'],
    usedIn: 4,
  },
  {
    key: 'isInternal',
    ...
    required: false,
    example: 'true',
    desc: 'Derived: email ends with @kocharsoft.com.',
    usedIn: 6,
  },
]
